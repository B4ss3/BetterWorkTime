...
public partial class SettingsWindow : Window
{
    ...
    private void PopulateSoundCombo()
    {
        ...
        SoundCombo.Items.Add(new SoundItem("(Custom)",     null)); // placeholder for custom
    ...
    private void SoundCombo_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        ...
        {
            // Custom item selected but no path yet — show current custom label
            CustomSoundLabel.Visibility = _customSoundPath != null
    ...
    private void PreviewSound_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show("Sound file not found.", "BetterWorkTime");
            return;
        }
        ...
        {
            MessageBox.Show($"Could not play sound: {ex.Message}", "BetterWorkTime");
        }
    }
